...
List<DictModel> dictModelFromJson(String str) => List<DictModel>.from(json.decode(str).map((x) => DictModel.fromJson(x)));

String dictModelToJson(List<DictModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
